...
pkg_mini:
	mkdir -p pkg
	printf "/* $(N)-$(VERSION).min.js | MIT license: http://github.com/jmettraux/$(N)/LICENSE.txt */" > pkg/$(N)-$(VERSION).min.js
...
pkg_comp:
	mkdir -p pkg
	printf "/* $(N)-$(VERSION).com.js | MIT license: http://github.com/jmettraux/h.js/LICENSE.txt */\n" > pkg/$(N)-$(VERSION).com.js
